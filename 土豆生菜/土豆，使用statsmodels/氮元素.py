...
# 施肥量和生菜产量的数据
fertilizer = np.array([0, 34, 67, 101, 135, 202, 259, 336, 404, 471])  # 千克每公顷
yield_data = np.array([15.18, 21.36, 25.72, 32.29, 34.04, 39.45, 43.15, 43.46, 40.83, 30.75])  # 吨每公顷

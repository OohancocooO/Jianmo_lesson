...
# 施肥量和生菜产量的数据
fertilizer = np.array([0, 47, 93, 140, 168, 279, 372, 465, 554, 651]) #千克每公顷
yield_data = np.array([15.75, 16.76, 16.89, 16.24, 17.56, 19.20, 17.97, 15.84, 20.11, 19.40]) # 吨每公顷

...
toolbox.register("individual", tools.initRepeat, creator.Individual, toolbox.attr_float, n=len_ch)
toolbox.register("population", tools.initRepeat, list, toolbox.individual)

toolbox.register("mate", tools.cxBlend, alpha=0.5)  # 使用适合基因数为1的交叉操作
toolbox.register("mutate", tools.mutGaussian, mu=0, sigma=0.1, indpb=0.2)  # 使用Gaussian变异
